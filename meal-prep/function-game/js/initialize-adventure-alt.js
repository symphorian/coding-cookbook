...
function updatePlayer() {
  ...
  if (isPlayerAttacking()) {
    // asset from interdimensional_/LUNARSIGNALS on opengameart.org
    player.src = 'images/notlinkattack.gif';
  } else {
    switch(playerDirection) {
      case UP:
        // asset from interdimensional_/LUNARSIGNALS on opengameart.org
        player.src = 'images/notlinkback.gif';
        break;
      case DOWN:
        // asset from interdimensional_/LUNARSIGNALS on opengameart.org
        player.src = 'images/notlinkfront.gif';
        player.classList.remove('face-left');
        break;
      case RIGHT:
        // asset from interdimensional_/LUNARSIGNALS on opengameart.org
        player.src = 'images/notlinkside.gif';
        player.classList.remove('face-left');
        break;
      case LEFT:
        // asset from interdimensional_/LUNARSIGNALS on opengameart.org
